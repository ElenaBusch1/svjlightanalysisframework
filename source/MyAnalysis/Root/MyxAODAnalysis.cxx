...
StatusCode MyxAODAnalysis :: execute ()
{
  ...
  //m_jetE->clear();
  //for (const xAOD::Jet* jet : *jets) {
  //  m_LargeRJets[0][0]->push_back (jet->eta ());
